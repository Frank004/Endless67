...
// CleanupManager import removed - delegated to scene.cleanupSystem
...
export class LevelManager {
    constructor(scene) {
        ...
        // this.cleanupManager removed - using scene.cleanupSystem
    ...
    cleanupOnly(limitY = null) {
        ...
        // Delegate to CleanupSystem
        if (scene.cleanupSystem) {
            scene.cleanupSystem.cleanup(calculatedLimitY);
        }
    }
